...
namespace plf
{
	...
	public:
		...
		sound(): sample(NULL) {}; // For inherited entities because c++ inheritance is... just... just, terrible... anyway, this means when the derived class is destructed and calls the base class destructor (after it calls it's own) everything won't explode in a shower of goo
		virtual ~sound();
